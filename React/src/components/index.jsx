                ...
                <div className="footer-wrap">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <h4>Contact us</h4>
                            <ul>
                                <li><PhoneIcon className="icon-f w-5 h-5" /> +256780385216</li>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <ul className="d-flex socials">
                                <li>
                                    <Link to="https://www.instagram.com/liquor_at_thealibi">
                                ...
                                <li>
                                    <Link to="https://www.tiktok.com/@thealibiliquor">
