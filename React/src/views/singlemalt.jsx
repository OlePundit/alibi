...
export default function SingleMalt(){
    ...
    const getProducts = () => {
        setLoading(true);
        axiosClient.get(`/products?includeUsers=true&includeSingleMalt=true&page=${currentPage}`)
            .then(({ data }) => {
                setLoading(false);
        ...
        <div className="products container py-5">
            <div className="row justify-content-center job-contents d-flex">
                <div className="heading-container">
                    <h2 className="heading">Single Malt Whisky</h2>
